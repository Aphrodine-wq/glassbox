...
| obfuscated (honest) | 6 | **3 caught (50%)** | 3 documented misses, 3 catch-control |
...
The 50% on the obfuscated set is the point, not a flaw: the floor stays small
**by design**, and the eval names every action it misses (`find -delete`,
